...
A separate full-file game-line audit on 2026-09-15 verified 7,548 schedule rows from 1999 through 2026, including 7,292 settled games with spread and total lines. The source has no sportsbook identity or line-capture timestamp. It is classified `NFLVERSE_SCHEDULE_UNKNOWN_BOOK`: eligible for a future generic historical baseline after normalization, but ineligible for FanDuel-specific calibration, book-specific closing-line value, or precise line-movement claims. See `engineering/NFLVERSE_GAME_LINES_SOURCE_AUDIT_2026-09-15.md`.
