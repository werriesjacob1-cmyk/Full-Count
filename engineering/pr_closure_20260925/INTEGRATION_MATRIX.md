...
| `claude/tier1-research-integration-20260925` | `59492822f8` | #210 tree + #202, #203, #204, #205, #207, #213 | pending: TIER1_ROOT | ✅ [36164938965](https://github.com/werriesjacob1-cmyk/Full-Count/actions/runs/36164938965) | Merges are conflict-free. The frozen harness, protocol, seal builder and drivers are byte-identical to `e05e02c592`. There is no production reference. |
| `claude/pr186-integration-20260925` | `6f549c9d0a` | main + #186 (append-only handoff union) + #212 + #208/#210 | pending: PR186_ROOT | ✅ 36165038564; web ✅ 36165038510 | Main's handoff is preserved as a byte prefix. Rushing and F16 tests pass. |
| `claude/merge-sequence-integration-20260925` | `9abf854193` | Everything above, in the proposed order | pending: SEQ_ROOT | pending: SEQ_NFL | 95 NFL test files pass, and the browser fixture passes 12/12 (on `0b39dc7ad0`, before the §16 wording fix) |
...
Count: 9 Tier 1 / #208 / #210 / #177 / #186 / #212 items + 2 active pricing + 4 review-required + 2 Codex after-refresh + 1 active + 7 handoff repairs + 2 clean Claude + 2 superseded + 13 re-rooted = **44**.
