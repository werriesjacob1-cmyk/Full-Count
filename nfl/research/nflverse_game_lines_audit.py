...
def run_audit(games: Path, closing: Path, initial: Path, manifest: dict) -> dict:
    ...
    return {
        ...
        "eligibility": {
            ...
            "retrospective_closing_line_benchmark": True,
            "point_in_time_feature": False,
            "fanduel_specific_calibration": False,
            "book_specific_clv": False,
            "precise_open_to_close_research": False,
        },
        "fail_closed_reasons": [
            "games.csv closing lines are sourced from Pro-Football-Reference, not an identified sportsbook",
