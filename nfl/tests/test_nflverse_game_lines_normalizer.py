...
class NflverseGameLineNormalizerTests(unittest.TestCase):
    def test_normalizes_spread_total_outcomes_and_provenance(self):
        ...
        self.assertEqual(got["source_class"], "NFLVERSE_PFR_CLOSING")
        self.assertEqual(got["market_vintage"], "CLOSING")
        self.assertEqual(got["allowed_use"], "RETROSPECTIVE_BENCHMARK_CONTROL_ONLY")
        self.assertFalse(got["point_in_time_feature_eligible"])
