...
class GameIdentityTests(unittest.TestCase):
    ...
    def test_total_only_snapshot_cannot_prove_team_identity(self):
        total_only = snapshot(records=[{"canonical_market": "game_total", "market_time": "2026-09-15T00:15:00Z"}])
        with self.assertRaisesRegex(GameIdentityError, "no team-bearing"):
    ...
    def test_normalized_records_must_agree_on_team_identity(self):
        ...
        records[1] = dict(records[1], home_team_name="Other Team")
