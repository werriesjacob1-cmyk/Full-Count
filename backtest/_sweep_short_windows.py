...
OUT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_sweep_short_windows_pairs.jsonl")
STATE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_sweep_short_windows_state.json")
